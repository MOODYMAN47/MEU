...
<main role="main">
    ...
    <section class="jumbotron text-center">
        <div class="container pt-lg-5 pl-5 px-5">
            <h1 class="display-3">HOŞGELDİNİZ</h1>
            <p class="lead text-muted">EN GÜZEL TATİL İÇİN </p>
            <p>
                <?php if ($isSessionExists) { ?>
                <a href="#" class="btn btn-success my-2" data-toggle="modal" data-target=".book-now-modal-lg">Rezervasyon Yapın<i class="fas fa-angle-double-right ml-1"></i></a>
                <?php } else { ?>
                <a href="#" class="btn btn-success my-2" data-toggle="modal" data-target=".sign-in-to-book-modal">Rezervasyon Yapın<i class="fas fa-angle-double-right ml-1"></i></a>
                <?php } ?>
            </p>
        </div>
    </section>
    ...
    <div class="container">
        <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
            <h1 class="display-4">Niye Tercih Ederim</h1><br>
            <p class="lead">Bu otel, şehrin kalbindeki mükemmel konumuyla öne çıkıyor ve bu da onu hem işadamları hem de turistler için ideal bir seçim haline getiriyor.<br>
                Otel, lüks restoranları, harika bir yüzme havuzunu, fitness ve dinlenme alanlarını içeren muhteşem olanaklarıyla öne çıkmaktadır.</p>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            <p class="card-text">Duyuları yeniden canlandırmak için mükemmel bir sığınak olan, güzel bir şekilde döşenmiş 24 m2lik Deluxe Oda, saf bir incelik ve zarafet yayıyor. Üst katlarda yer alan Deluxe Odaların her biri, yaşam alanınızı atmosferik bir meskene dönüştüren yükseltilmiş tavanlar ve tam boy cumbalı pencerelerle karakterize edilmiştir.</p>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            <p class="card-text">
                                Standart iki yataklı oda, iki kişinin konaklamasına uygun iki adet tek kişilik yatakla donatılmıştır. Optimum güvenlik düzeyine sahip baştan çıkarıcı birinci sınıf olanaklar ve tamamen klimalı iki yataklı oda, ihtiyaçlarınız için mükemmel seçim olmaya devam ediyor. Otel odalarını bizimle rezerve edin ve seyahatinizin keyfini tüm heyecanıyla çıkarın.                            </p>
                            <div class="d-flex justify-content-between align-items-center">
                                <?php if ($isSessionExists) { ?>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            <p class="card-text">
                                Mütevazı büyüklükte tek kişilik odada duş ve/veya küvet, saç kurutma makinesi ve ücretsiz banyo malzemeleri içeren en-suite banyo bulunmaktadır. Olanaklar arasında ücretsiz Wi-Fi, telefon, minibar ve çeşitli kanal ve filmleri izleyebileceğiniz düz ekran TV bulunmaktadır.                            </p>
                            <div class="d-flex justify-content-between align-items-center">
                                <?php if ($isSessionExists) { ?>
